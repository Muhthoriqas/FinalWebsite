        ...
        <div class="card-body bg-transparent">
            ...
            <form method="post" action="<?= base_url('pegawai/store') ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="no_telp" name="no_telp" value="<?= old('no_telp') ?>" placeholder="Masukkan Nomor Telepon/WA"/>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="alamat" id="alamat" placeholder="Masukkan Alamat Sekarang"><?= old('alamat') ?></textarea>
                </div>
